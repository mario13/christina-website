...
import org.leiv.web.ProjectController;
...
privileged aspect ProjectController_Roo_Controller {
    ...
    public String ProjectController.show(@PathVariable("id") Integer id, Model uiModel) {
    ...
    public String ProjectController.updateForm(@PathVariable("id") Integer id, Model uiModel) {
        populateEditForm(uiModel, Project.findProject(id));
        return "projects/update";
    }
    
    @RequestMapping(value = "/{id}", method = RequestMethod.DELETE, produces = "text/html")
    public String ProjectController.delete(@PathVariable("id") Integer id, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
